...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        KC_LSFT, KC_Z   , KC_X   , KC_C   , KC_D   , KC_V   ,            KC_INS , KC_K   , KC_H   , KC_COMM, KC_LDOT, KC_LSLS, \
    ...
    [SUPPORT] = LAYOUT(
        QK_BOOT, KC_ESC , KC_INS , KC_INT4, KC_INT5, XXXXXXX, XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
